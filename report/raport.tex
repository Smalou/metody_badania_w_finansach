...
\begin{itemize}
  ...
  \item Zadania 1 i 3 należy traktować jako analizę opisową spreadów względem
        ...
        natomiast Zad. 3 zachowuje dodatni efekt mimo tej korekty. Ponieważ
        CAPM-adjusted placebo także jest istotne, nie traktujemy wyniku jako
        dowodu przyczynowego wpływu premiery ChatGPT.
